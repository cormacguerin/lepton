...
# Library Files
#
REDIS_CLIENT_LIB = /usr/local/lib/libcpp_redis.a /usr/local/lib/libtacopie.a
PQXX_CLIENT_LIB = /usr/local/lib/libpqxx.a
...
LD_FLAGS  = $(REDIS_CLIENT_LIB) $(PQXX_CLIENT_LIB)
CFLAGS    = ${INCLUDES} 

...
all: query.o server.o session.o quark.o proton.o neutron.o base64.o segmenter.o
	${LINKER} -o atom query.o server.o session.o quark.o proton.o neutron.o base64.o segmenter.o $(LD_FLAGS)

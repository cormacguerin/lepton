...
_this44.loadComplete=false;_this44.message='What would you like to search for today.';return _this44;}/**
     ...
     */babelHelpers.createClass(StartLitElement,[{key:"render",value:function render(){return html$1(_templateObject_4881e580dfc311e9a9caf342f5dd962f(),this.message,this.handleInput,this.search);}},{key:"handleInput",value:function handleInput(e){this.searchquery=e.target.value;}},{key:"search",value:function search(e){console.log("e.target.value");console.log(e.target.value);console.log("this.searchquery");console.log(this.searchquery);var ajaxsearch=this.shadowRoot.getElementById('ajaxsearch');ajaxsearch.params={"query":this.searchquery};ajaxsearch.generateRequest();}},{key:"searchResponse",value:function searchResponse(data){console.log(data.detail.response);}/**

...
//		std::cout << "READ FILE for shard " << shard_id << std::endl;
...
//			std::cout << "term : " << jit->name.GetString() << std::endl;
			...
			for (rapidjson::Value::ConstMemberIterator jtit = jit->value.MemberBegin(); jtit != jit->value.MemberEnd(); ++jtit) {
				Term term;
//				std::cout << "  n: " << jtit->name.GetString() << std::endl;
				for (rapidjson::Value::ConstMemberIterator jtit_ = jtit->value.MemberBegin(); jtit_ != jtit->value.MemberEnd(); ++jtit_) {
//					std::cout << "  n_: " << jtit_->name.GetString() << std::endl;
//					std::cout << "  v_: " << jtit_->value.GetDouble() << std::endl;
